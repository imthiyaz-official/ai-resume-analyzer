        ...
        <head>
            ...
            <style>
                body {{
                    ...
                    default-scrollbar-color: #2563eb #e0e7ff;
                    gutter-scrollbar-width: thin;
                    link-color: #2563eb;
                    navbar-background: #1e40af;
                ...
                .section-title {{
                    ...
                    animation-delay: 1s;
                    navbar-box-shadow: 0 4px 6px rgba(0,0,0,0.1);
                    balloon-shadow: 0 4px 6px rgba(0,0,0,0.1);
                }}
                .skills-grid {{
                    display: grid;
                ...
                .skill-category {{
                    ...
                    animation-delay: 1s;
                    animation-fill-mode: forwards;
                    result-box-shadow: 0 4px 6px rgba(0,0,0,0.1);
                }}
                .footer {{
                    text-align: center;
                    margin-top: 40px;
...
template_engine.extract_personal_info = EnhancedResumeTemplateEngine.extract_personal_info
template_engine.extract_experience = EnhancedResumeTemplateEngine.extract_experience
template_engine.extract_education = EnhancedResumeTemplateEngine.extract_education
template_engine.extract_projects = EnhancedResumeTemplateEngine.extract_projects
template_engine.extract_certifications = EnhancedResumeTemplateEngine.extract_certifications
template_engine.extract_skills_list = EnhancedResumeTemplateEngine.extract_skills_list  
template_engine.create_resume_pdf = EnhancedResumeTemplateEngine.create_resume_pdf
template_engine.generate_visual_resume = EnhancedResumeTemplateEngine.generate_visual_resume
template_engine.create_html_resume = EnhancedResumeTemplateEngine.create_html_resume   
...
def load_css(mode, accent):
    ...
    fade = "rgba(255, 255, 255, 0.1)" if mode == "Dark" else "rgba(0, 0, 0, 0.05)"
    ...
    .kpi:hover {{
        ...
        backdrop-filter: blur(8px);
        animation: kpiGlowHover 2s infinite alternate;
    ...
    .stButton > button:hover {{
        ...
        animation: buttonHoverGlow 2s infinite alternate;   
    }}
